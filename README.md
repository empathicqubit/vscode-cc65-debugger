...
of my test project), and VICE Nightly r38529 or later (you should install an
...
my test project the same way as before), and VICE Nightly r38529 (or a later
...
choco install --pre --version 3.4-r38529 winvice-nightly
choco install llvm
```
