...
of my test project), and VICE Nightly r38557 or later (you should install an
...
my test project the same way as before), and VICE Nightly r38557 (or a later
...
choco install --pre --version 3.4.20200919-r38557 winvice-nightly
choco install llvm
```
...
To install VICE r38557 before version 3.5 is released, you will need to build
